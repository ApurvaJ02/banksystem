<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #C0392B;"><b>SPARKS INDIAN BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#about" style="color : #C0392B;"><b>About Us</b></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#contact" style="color : #C0392B;"><b>Contact</b></a>
              </li>
          </div>
       </nav>
